      ...
      <div className={styles.frame}>
        ...
        <ul>
          <li className={styles.frame}>
            ...
            <h3>&quot;Kaimux&quot; Minecraft Project</h3>
            <h3>February 2023 - Present (Part-Time, Remote)</h3>
            <h4>
        ...
        <h2>Not related to IT</h2>
        <ul>
          <li className={styles.frame}>
            <h2>Warehouse Worker-Driver</h2>
            <h3>UAB &quot;Manrasta&quot;</h3>
            <h3>May 2024 - September 2024 (Full-Time, On-Site)</h3>
            <h4>
          ...
          <li className={styles.frame}>
            ...
            <h3>January 2022 - April 2023 (Full-Time, On-Site)</h3>
            <h4>
          ...
          <li className={styles.frame}>
            ...
            <h3>July 2018 - August 2018 (Full-Time, On-Site)</h3>
          ...
          <li className={styles.frame}>
            ...
            <h3>June 2017 - August 2017 (Full-Time, On-Site)</h3>
